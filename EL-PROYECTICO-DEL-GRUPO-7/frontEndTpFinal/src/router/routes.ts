...
const routes: RouteRecordRaw[] = [
...

  {
    ...
    meta: { auth: false },
    children: [
      { path: 'plazas', component: () => import('pages/PlazasPage.vue'), meta: { auth: false } },
      { path: 'precios', component: () => import('pages/PreciosPage.vue'), meta: { auth: false } },
      { path: 'promociones', component: () => import('pages/PromocionesPage.vue'), meta: { auth: false } },
      { path: 'planes', component: () => import('pages/PlanesPage.vue'), meta: { auth: false } },
      { path: 'horarios', component: () => import('pages/HorariosPage.vue'), meta: { auth: false } },
      { path: 'listaEmpleados', component: () => import('pages/ListaEmpleados.vue'), meta: { auth: false } },
      { path: 'nuevoEmpleado', component: () => import('pages/NuevoEmpleado.vue'), meta: { auth: false } },
      { path: 'configuraciones', component: () => import('pages/ConfiguracionesPage.vue'), meta: { auth: false } },
    ],
  },
